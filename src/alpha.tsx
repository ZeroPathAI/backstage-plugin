/**
 * ZeroPath Backstage Plugin - New Frontend System (Alpha)
 *
 * This module exports the plugin for the new Backstage frontend system.
 *
...
// Page Extension - standalone /zeropath page
const zeroPathPageExtension = PageBlueprint.make({
  ...
  params: {
    ...
    loader: async () => {
      const { ZeroPathPage } = await import('./components/ZeroPathPage');
      return <ZeroPathPage />;
    },
  },
});

// Nav Item Extension - sidebar link
